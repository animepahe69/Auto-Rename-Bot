...
class Config(object):
    ...
    # database config
    DB_NAME = os.environ.get("DB_NAME","xbotz")     
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://Yuuichi:Yuuichi@cluster0.vuuobqn.mongodb.net/?retryWrites=true&w=majority")
    ...
    FORCE_SUB   = os.environ.get("FORCE_SUB", "Anime_Bloodline") 
